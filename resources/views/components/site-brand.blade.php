<a {{ $attributes->merge(['href' => route('home'), 'aria-label' => 'Fan Hub Plus home'])->class('fh-brand fh-brand--premium') }}>
    <svg class="fh-brand-mark" viewBox="0 0 48 48" fill="none" aria-hidden="true">
        ...
        <path d="m14 13 20 0-3 7H21v5h8l-3 7h-5v6l-7-4Z" fill="#161923"/>
        <path d="M36 5v10m-5-5h10" stroke="currentColor" stroke-width="3" stroke-linecap="round"/>
    </svg>
    <span class="fh-brand-wordmark">FanHub<span>Plus</span><small>EVERY UNIVERSE. ONE HOME.</small></span>
</a>
