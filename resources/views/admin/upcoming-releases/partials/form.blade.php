                    ...
                    <div class="mb-3">
                        ...
                        <div class="fh-adm-pick-list fh-adm-pick-list--single">
                            <label class="fh-adm-pick-item">
                                <input type="radio" name="image_media_id" value="" @checked((int) old('image_media_id', $release?->image_media_id) === 0)>
                            ...
                            @forelse ($images as $image)
                                <label class="fh-adm-pick-item">
                                    <input type="radio" name="image_media_id" value="{{ $image->id }}" @checked((int) old('image_media_id', $release?->image_media_id) === $image->id)>
                                    <div class="fh-adm-pick-item-body">
