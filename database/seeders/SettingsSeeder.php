...
class SettingsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $settings = [
            ...
            ['group' => 'seo', 'key' => 'meta_title', 'value' => 'FanHubPlus', 'type' => 'text'],
            ['group' => 'seo', 'key' => 'meta_description', 'value' => 'A production-ready FanHubPlus with roles, API, and admin panel', 'type' => 'textarea'],
        ...
        $mailSettings = [
            ...
            ['group' => 'mail', 'key' => 'mail_from_name', 'value' => 'FanHubPlus', 'type' => 'text'],
